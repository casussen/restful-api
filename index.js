...
restService.post("/account.balance.check", function(req, res) {
  var speech = req.body.result && req.body.result.parameters && req.body.result.parameters.account ? req.body.result.parameters.account
  return res.json({
    speech: speech,
    displayText: speech,
    source: "webhook-account.balance.check-sample"
  });
});
